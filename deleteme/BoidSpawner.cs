...
public class BoidSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        BlobBuilderArray<BoidManager> blobManagerArray = bb.Allocate(ref bmb.blobManagerArray, 9);
        blobManagerArray[0] = new BoidManager
        {
    ...
    private void Update()
    {
        ...
        if (elapsedTime >= interval)
        {
            ...
            for (int i=0; i<=boidsPerInterval; i++)
            {
                ...
                entitymanager.AddComponentData(e, new BoidComponent
                {
