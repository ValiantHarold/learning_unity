...
public class BoidMovement : SystemBase
{
    public NativeMultiHashMap<int, BoidComponent> cellVsEntityPositions;
    ...
    {
        cellVsEntityPositions = new NativeMultiHashMap<int, BoidComponent>(0, Allocator.Persistent);
    }

    protected override void OnUpdate()
    {
        EntityQuery eq = GetEntityQuery(typeof(BoidComponent));
        ...
        NativeMultiHashMap<int, BoidComponent>.ParallelWriter cellVsEntityPositionsParallel = cellVsEntityPositions.AsParallelWriter();
        Entities.ForEach((ref BoidComponent bc, ref Translation trans) =>
        {
            BoidComponent bcValues = new BoidComponent();
            bcValues = bc;
        ...
        NativeMultiHashMap<int, BoidComponent> cellVsEntityPositionsForJob = cellVsEntityPositions;
        Entities.WithBurst().WithReadOnly(cellVsEntityPositionsForJob).ForEach((ref BoidComponent bc, ref Translation trans, ref Rotation rot) =>
        {
